          ...
          <div>
            <div className="flex items-center gap-3 mb-1">
              ...
              <span className={`px-2.5 py-0.5 rounded-full text-xs font-medium ${
                ...
                details.status === 'Active' ? 'bg-blue-100 text-blue-800' :
                ...
                <table className="w-full text-sm">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-left font-medium text-gray-500">Wallet Details</th>
                    ...
                    {details.employees.map((emp: any) => (
                      <tr key={emp.id} className="hover:bg-gray-50/50">
                        ...
                        <td className="px-4 py-3 text-gray-600 font-mono text-xs">
                          <div>{emp.wallet}</div>
                          <div className="text-gray-400">{emp.chain}</div>
                        </td>
                        <td className="px-4 py-3 text-right font-medium">
                         ...
                         <td className="px-4 py-3 text-right">
                          <span className={`inline-flex items-center px-2 py-0.5 rounded text-[10px] font-medium ${
                            emp.status === 'Paid' ? 'bg-green-50 text-green-700' :
                            emp.status === 'Paused' ? 'bg-yellow-50 text-yellow-700' :
