...
/// @dev Verifies payroll state before distribution
contract ArcPayrollDistributor is ReentrancyGuard, Ownable {
    ...
    /// @notice Verify payroll state signed by an authorized agent
    ...
    /// @param stateSignature Agent signed state
    ...
    /// @param stateSignature Agent state signature
